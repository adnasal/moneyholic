...
from newscraper.views import SymbolRemoveView, SymbolAddView, SymbolListView, ArticleListView
...
urlpatterns = [
    ...
    url(r'^api/v1/remove_symbol', SymbolRemoveView.as_view(), name='remove_symbol'),
